...
// doesnt need to be on the main thread
actor LogSystem {
    ...
    /*
     even though the syntax is within the actor,
     this function is not actually running in the actor,
     just for convinience, not to have to run the prints
     with 'Tasks' every time
     */
